...
USE_MULTIENV = False
USE_CONV = False
USE_MACRO_CHICKEN_POS = True
USE_MACRO_NOOP = True
USE_MACRO_ACTION = False
REWARD_SHAPING = False
Y_DOWNSAMPLING = False
X_DOWNSAMPLING = True
REPEAT_ACTION = False
...
SCREEN_HEIGHT = 12 if USE_MACRO_CHICKEN_POS else (52 if Y_DOWNSAMPLING else 210)
INLINE_LEFT = 40
INLINE_RIGHT = 50
MAX_LANE = 10
...
LANES = [(42, 47), (38, 42), (34, 38), (30, 34), (26, 30), (22, 26), (18, 22), (14, 18), (10, 14), (6, 10)] \
    if Y_DOWNSAMPLING and not USE_MACRO_CHICKEN_POS else \
    [(167, 187), (151, 169), (135, 153), (119, 137), (104, 121), (87, 104), (71, 89), (55, 73), (39, 57), (23, 41)]
CHICKEN_LANE_Y = (18, 28) if X_DOWNSAMPLING else (36, 55)
